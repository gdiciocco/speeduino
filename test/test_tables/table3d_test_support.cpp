...
TEST_DATA table3d_axis_t tempXAxis[] = { 900U/XAXIS_FACTOR, 1600U/XAXIS_FACTOR, 2500U/XAXIS_FACTOR, 3500U/XAXIS_FACTOR, 4700U/XAXIS_FACTOR, 5900U/XAXIS_FACTOR, 6750U/XAXIS_FACTOR, 6990U/XAXIS_FACTOR};

static constexpr table3d_axis_t YAXIS_FACTOR = 2U;
TEST_DATA table3d_axis_t tempYAxis[] = { 16U/YAXIS_FACTOR, 30U/YAXIS_FACTOR, 40U/YAXIS_FACTOR, 50U/YAXIS_FACTOR, 60U/YAXIS_FACTOR, 70U/YAXIS_FACTOR, 86U/YAXIS_FACTOR, 96U/YAXIS_FACTOR};

table3d8RpmLoad getDummyTable(void)
{
    table3d8RpmLoad testTable;
    populate_table(testTable, tempXAxis, tempYAxis, values);
    return testTable;
}