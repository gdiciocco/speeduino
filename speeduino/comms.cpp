...
// Keep these responses aligned with the signature/versionInfo in reference/speeduino.ini.
// There is intentionally no null terminator; the leading byte is the framed-protocol status.
static constexpr byte codeVersion[] PROGMEM = { SERIAL_RC_OK, 'C','a','p','o','n','o','r','d',' ','E','C','U',' ','2','0','2','6','0','1'};
static constexpr byte productString[] PROGMEM = { SERIAL_RC_OK, 'C','a','p','o','n','o','r','d',' ','E','C','U',' ','2','0','2','6','0','1'};
